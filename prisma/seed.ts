...
interface SeedProduct {
  ...
  labBatchCT?: string;
  tmvTmt?: string;
  rawMaterialQual?: string;
  trialMfg?: string;
  trialMfgDate?: string;
  bulkShelfLife?: string;
  bulkShelfLifeDate?: string;
  fillingPackaging?: string;
  labStability?: string;
  drugStability?: string;
  productReg?: string;
  importReg?: string;
...
const products: SeedProduct[] = [
  {
    ...
    uniiCode: "SLT240822AH01HSS01 Lab(0M) 완료, Lab(2M) 완료",
    preservative: "부국, 40/70ML 검토 완료",
    tmvTmt: "TMT 완료 (SCINIC으로 진행완료)",
    rawMaterialQual: "품질 진행중 완료 예상 9월",
    trialMfgDate: "2025-05-29", bulkShelfLifeDate: "2025-05-29",
    fillingPackaging: "완료",
  ...
  },
  {
    ...
    spf: "50", broadSpectrum: "O", waterResistant: "-",
    container: "튜브", volume: "40mL/70mL", devTeam: "SC1",
    formulator: "소영준", salesManager: "-",
    devNote: "HLK 본임상 결과 Label SPF 50, C.W: 380.0, UVA I/UV ratio: 0.87(SPF 53.1)",
    targetDate: "25년7월", devStatus: "완료", formulationConfirmed: "확정",
    activeIngredients: "HMS, EHS, OCT, BMdBM",
    clinicalTrial: "Label SPF 50, C.W: 380.0, UVA I/UV ratio: 0.87 (HLK)",
    tmvTmt: "TMT 완료 SLT250211AC04SYJ03(의뢰일 3/11)",
    fillingPackaging: "완료",
    labStability: "250616 시작, 벌크: 2M 특이사항 없음",
    drugStability: "KOTITI 진행 6/13 접수",
    stepStatuses: {
      formulation_dev: "completed", formulation_confirm: "completed",
      active_ingredients: "completed", clinical_trial: "completed",
  ...
  },
  {
    ...
    stepStatuses: {
      ...
      raw_material_qual: "pending", trial_mfg: "pending",
      bulk_shelf_life: "pending", filling_packaging: "pending",
      lab_stability: "pending", drug_stability: "pending",
      product_reg: "pending", import_reg: "pending",
      production_3batch: "pending", validation_3batch: "pending",
      drug_stability_2batch: "pending", shipment: "pending",
    },
  },
  {
    ...
    productType: "선크림", uvFilterType: "유기", devTeam: "SC1",
    formulator: "오민호", salesManager: "-",
    clinicalTrial: "LABEL SPF 50, C.W: 377.1, UVA I/UV ratio: 0.79 (HLK)",
    tmvTmt: "TMV/TMT 필요없음 (이즈앤트리로 진행완료)",
    stepStatuses: {
      formulation_dev: "completed", formulation_confirm: "completed",
      active_ingredients: "completed", clinical_trial: "completed",
      unii_code: "pending", preservative: "pending",
      lab_batch_ct: "pending", tmv_tmt: "na",
      raw_material_qual: "pending", trial_mfg: "pending",
      bulk_shelf_life: "pending", filling_packaging: "pending",
      lab_stability: "pending", drug_stability: "pending",
      product_reg: "pending", import_reg: "pending",
  ...
  },
  {
    ...
    stepStatuses: {
      ...
      active_ingredients: "completed", clinical_trial: "completed",
      unii_code: "pending", preservative: "pending",
      lab_batch_ct: "pending", tmv_tmt: "in_progress",
      raw_material_qual: "pending", trial_mfg: "pending",
      bulk_shelf_life: "pending", filling_packaging: "pending",
      lab_stability: "pending", drug_stability: "pending",
      product_reg: "pending", import_reg: "pending",
  ...
  },
  {
    ...
    stepStatuses: {
      ...
      unii_code: "pending", preservative: "pending",
      lab_batch_ct: "pending", tmv_tmt: "pending",
      raw_material_qual: "pending", trial_mfg: "pending",
      bulk_shelf_life: "pending", filling_packaging: "pending",
      lab_stability: "pending", drug_stability: "pending",
      product_reg: "pending", import_reg: "pending",
  ...
  },
  {
    ...
    stepStatuses: {
      ...
      unii_code: "pending", preservative: "pending",
      lab_batch_ct: "pending", tmv_tmt: "pending",
      raw_material_qual: "pending", trial_mfg: "na",
      bulk_shelf_life: "pending", filling_packaging: "pending",
      lab_stability: "pending", drug_stability: "na",
      product_reg: "pending", import_reg: "pending",
      production_3batch: "pending", validation_3batch: "pending",
      drug_stability_2batch: "pending", shipment: "pending",
    },
  ...
  },
  {
    ...
    stepStatuses: {
      formulation_dev: "pending", formulation_confirm: "pending",
      active_ingredients: "pending", clinical_trial: "pending",
      unii_code: "pending", preservative: "pending",
      lab_batch_ct: "pending", tmv_tmt: "pending",
      raw_material_qual: "pending", trial_mfg: "pending",
      bulk_shelf_life: "pending", filling_packaging: "pending",
